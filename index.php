...
$responses_en = [
    ['keywords' => ['anxious', 'worried', 'nervous'], 'response' => "I'm here to listen. Want to talk about what's making you feel this way?", "Okay"],
...
<body>
    <div id="languageModal">
        <div id="languageModalContent">
            ...
            <button class="lang-button" data-lang="cb">CEb</button>
        </div>
    </div>
    ...
    <div class="chat-box" id="chatBox">
        ...
        <nav>
            <div class="header">
                <button class="butt">&#9776</button><h2>Ask the AI Bot</h2>
            </div>
